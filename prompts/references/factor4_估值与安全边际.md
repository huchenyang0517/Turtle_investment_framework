...
**若 §6.1 有「每股不低于 X 元」承诺**：穿透回报率 = 承诺股息率 为常数，不随 AA 变化；敏感性表可标注「承诺股息率下固定，仅评估承诺可持续性」。

**若 §6.1 有「不低于归母净利润 Y%」承诺**：穿透回报率随 C（归母净利润）变化，须做 **C 情景敏感性**（C×1.0、C×0.9、C×0.8 时的穿透回报率与门槛价格），评估业绩下滑对股息率的影响。
